...
if ($conn && $listing_id > 0) {
    ...
    if (mysqli_stmt_execute($stmt)) {
        $_SESSION['admin_msg'] = "Listing approved successfully!";

        // Notify owner
        if ($listing_info) {
            $title = "Verification Approved";
            $message = 'Your listing "' . $listing_info['listing_name'] . '" has been verified! Customers will now see the verified badge.';
        ...
        $_SESSION['admin_msg'] = "Error approving listing.";
    }
